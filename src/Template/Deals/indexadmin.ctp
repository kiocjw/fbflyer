                      ...
                      <ul class="unstyled list-inline row">
                        ...
                        <li>
                             <span class="">
                              ...
                              <?php if (isset($deal->status)){switch($deal->status):case 0:echo ("Pending");break;case 1:echo ("Approved");break;case 2:echo ("Reworked");break;case 3:echo ("Rejected");break;endswitch;}?>
                            </span>
                        </li>
                      </ul>
                    </footer>
