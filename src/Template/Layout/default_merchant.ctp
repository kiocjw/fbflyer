                                ...
                                <ul class="nav navbar-nav navbar-left">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li>
                                               <?php echo $this->Html->link("MY BRANCHES", ['controller' => 'merchants','action' => 'index']);?>
                                            </li>

                                            <li>
                                               <?php echo $this->Html->link("NEW BRANCHES", ['controller' => 'merchants','action' => 'add']);?>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li>
                                               <?php echo $this->Html->link("MY DEALS", ['controller' => 'deals','action' => 'index']);?>
                                            </li>

                                            <li>
                                               <?php echo $this->Html->link("NEW DEALS", ['controller' => 'deals','action' => 'add']);?>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
