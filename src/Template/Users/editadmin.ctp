                  ...
                  <?= $this->Form->create($user); ?>
                            <?php
                                    if($user->facebook_id==NULL)
                                    {
                                            ...
                                            echo $this->Form->input('new password',array('type' => 'password','div'=>array('class'=>'form-group'),'class' => 'form-control'));
                                            echo $this->Form->input('confirm new password',array('type' => 'password','div'=>array('class'=>'form-group'),'class' => 'form-control'));
                                     }
                             ?>
